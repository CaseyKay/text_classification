...
class TextCNN:
    def __init__(self, filter_sizes,num_filters,num_classes, learning_rate, batch_size, decay_steps, decay_rate,sequence_length,vocab_size,embed_size,
        ...
        self.logits = self.inference() #[None, self.label_size]. main computation graph is here.  计算图构建
    ...
    def inference(self):
        ...
        # 1.=====>get emebedding of words in the sentence  embedding 过程
       ...
       for i in range(500):
           ...
           loss,possibility,W_projection_value,_=sess.run([textRNN.loss_val,textRNN.possibility,textRNN.W_projection,textRNN.train_op],
                                                          feed_dict={textRNN.input_x:input_x,
                                                               textRNN.input_y_multilabel:input_y_multilabel,
